...
const botScript = async () => {
  try {
    await (async () => {
      ...
      const arcadeUrl = "https://archive.org/advancedsearch.php?q=collection:internetarcade&rows=10000&page=1&output=json";
      const respJSON = await fetchJSON(arcadeUrl);
