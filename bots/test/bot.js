...
import recordYoutubeVideo from "./../../modules/recordYoutubeVideo.js";
...
const botScript = async () => {
  await (async () => {
    try {
      ...
      await recordYoutubeVideo(webcam.url, botID);
      // await extractVideoLive(webcam.youtube_url, `${botID}.mp4`, 10);
      console.log('path check', __dirname + `/../../temp/${botID}.gif`);

      mastodon.postImage({
        status,
        image: __dirname + `/../../temp/${botID}.gif`,
