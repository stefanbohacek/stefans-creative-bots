const fs = require("fs"),
  ...
  webcams = require(__dirname + "/../data/webcams-underwater.js"),
...
const mastodon = new mastodonClient({
  access_token: process.env.UNDERWATER_BOT_ACCESS_TOKEN_SECRET,
  api_url: process.env.UNDERWATER_BOT_API,
});

const fileName = "underwater.mp4";
  ...
  links: [
    {
      ...
      url: "https://botsin.space/@underwater",
    },
  ],
